                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="h-10 px-4 bg-green-600 text-white rounded-xl text-sm font-semibold hover:bg-green-700 transition-colors shadow-sm flex items-center gap-2"
                            >
                                <UserPlus size={16} />
                                Add Teacher
                            </button>
                            ...
                            <button
                                ...
                                className="h-10 px-4 bg-blue-600 text-white rounded-xl text-sm font-semibold hover:bg-blue-700 transition-colors shadow-sm flex items-center gap-2"
                            >
                                <Plus size={16} />
                                Add Certificate
                            </button>
