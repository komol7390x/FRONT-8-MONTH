...
interface AdminCardProps {
    ...
    handleRecover?: (id: number) => Promise<void>;
...
export const AdminCard: React.FC<AdminCardProps> = ({ admins, getInitials, openModal, showMore = true, showDelete = true, showEdit = true, showBlock = true, showRecover = false, handleSoftDelete, handleRecover, handleBlock, isBlocking, isDeleting = false, deletedIds = [], page, limit }) => {
    return (
        <div>
            {admins.length === 0 ? (
