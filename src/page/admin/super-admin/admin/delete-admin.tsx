                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    {admin.avatarUrl ? (
                      ...
                      <div className="w-12 h-12 bg-gradient-to-br from-gray-600 to-gray-700 rounded-full flex items-center justify-center text-white font-semibold text-lg">
              ...
              {modalType === 'more' && (
                <div className="space-y-4">
                  ...
                  <div className="border-t pt-4 space-y-2">
                    <div className="group flex items-center justify-between p-2.5 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg hover:shadow-sm transition-all duration-200">
                    ...
                    <div className="group flex items-center justify-between p-2.5 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg hover:shadow-sm transition-all duration-200">
                      <div className="flex-1">
                    ...
                    <div className="group flex items-center justify-between p-2.5 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg hover:shadow-sm transition-all duration-200">
                      <div className="flex-1">
                    ...
                    <div className="group flex items-center justify-between p-2.5 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg hover:shadow-sm transition-all duration-200">
                      <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between p-2.5 bg-gradient-to-r from-orange-50 to-red-50 rounded-lg">
                      <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between p-2.5 bg-gradient-to-r from-teal-50 to-cyan-50 rounded-lg">
                      <div className="flex-1">
                    ...
                    <div className="group flex items-center justify-between p-2.5 bg-gradient-to-r from-gray-50 to-slate-50 rounded-lg hover:shadow-sm transition-all duration-200">
                      <div className="flex-1">
