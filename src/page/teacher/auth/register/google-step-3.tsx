...
const STORAGE_KEY_STEP2 = 'teacher_google_register_step2';
const STORAGE_KEY_STEP3 = 'teacher_google_register_step3';

export const GoogleRegisterTeacherStep3: React.FC = () => {
    ...
    useEffect(() => {
        const hasState = !!(state.phoneNumber || state.password || state.otp || state.id || state.email);
        if (hasState) return;
        try {
        ...
        <div className="min-h-screen bg-[#f0f2f5] flex items-center justify-center p-4">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-lg p-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <h2 className="text-xl font-bold text-gray-900">Google Register Step 3 (OTP)</h2>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-2">
                        <button
                            type="button"
                            onClick={() => navigate('/teacher/google/step-2', { state })}
